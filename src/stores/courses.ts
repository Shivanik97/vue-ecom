...
export const useCoursesStore = defineStore('courses', () => {
  ...
  const courses = ref([
    ...
    },
    {
      ...
      desc: 'Building apps with Vue is a delight but there are common gotchas you should look out for! With this course, learn the warning signs and ways to fix them.',
      isFav: false,
      inCart: false,
    ...
    },
    {
      ...
      desc: 'Master internationalization and learn how to create multilingual websites and vue.js applications with vue-i18n.',
      isFav: false,
      inCart: false,
    ...
    },
    {
      ...
      desc: 'Components are the puzzle pieces of a Vue.js website. Learn the fundamental and important concept of Vue.js components in this course.',
      isFav: false,
      inCart: false,
    ...
    },
    {
      ...
      desc: "Vitest is a testing framework built for Vite! It's blazing fast test runs and zero config setup make testing a breeze for Vue.js 3 projects.",
      isFav: false,
      inCart: false,
